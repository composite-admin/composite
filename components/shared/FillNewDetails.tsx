      ...
      <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-5 radio my-2">
            <div>
              <input
                ...
                name="report_type"
                id="Daily"
                checked={formData.report_type == "Daily"}
                value="Daily"
            ...
            <div>
              <input
                ...
                name="report_type"
                id="Weekly"
                checked={formData.report_type == "Weekly"}
                value="Weekly"
                onChange={handleInputChange}
              />
        ...
        <div className="grid grid-cols-2 gap-5 edit">
          <div className="flex flex-col">
            ...
            >
              {projects &&
                projects?.data?.map((pj: any) => (
                  <option key={pj.id} value={pj.project_name}>
                    {pj.project_name}
                  </option>
                ))}
            </select>
        ...
        <div className="grid grid-cols-2 gap-5 edit-info">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              value={formData.weekly_projection}
              onChange={handleInputChange}
            ></textarea>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              value={formData.materials_required_for_projection}
              onChange={handleInputChange}
            ></textarea>
          </div>
