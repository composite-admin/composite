...
export default function ReportPage() {
  ...
  const filter = (type: string) => {
    let newData = reportData.filter((item: any) => item.report_type == type)
    setData(newData);
  }
  ...
  return (
    <div>
      ...
      <div className="flex gap-3 my-5">
        <div className='bg-[#007BFF08] text-sm rounded-md flex items-center p-3 gap-1 cursor-pointer' onClick={() => setData(reportData)}>
        ...
        <div className='bg-[#E7F6EC] text-sm rounded-md flex items-center p-3 gap-1 cursor-pointer' onClick={() => filter("Daily")}>
        ...
        <div className='bg-[#FEF6E7] text-sm rounded-md flex items-center p-3 gap-1 cursor-pointer' onClick={() => filter("Weekly")}>
        ...
        <div className='bg-[#FFECE5] text-sm rounded-md flex items-center p-3 gap-1 cursor-pointer' onClick={() => filter("Monthly")}>
