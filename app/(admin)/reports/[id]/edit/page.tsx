        ...
        <div className="my-5 rounded-lg border border-outline bg-white p-[29px]">
                <div className="grid grid-cols-[1fr_3fr]  gap-10 pb-10">
                    <div className="flex gap-3 flex-col">
                        <div className="">
                            <h2 className="text-textColor2 text-[16px] font-[600]">Edit Report</h2>
                            <p className="text-sm text-textColor">Update report details here.</p>
                        </div>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="grid grid-cols-2 gap-5 edit-info">
                            ...
                            <button className="bg-primaryLight text-white  p-4 rounded-md">Submit</button>
